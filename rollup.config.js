...
export default [
  ...
  makeCJSConfig('Header/index', 'Header'),
  makeCJSConfig('Rule/index', 'Rule'),
  makeCJSConfig('Screen/index', 'Screen'),
  makeCJSConfig('Text/index', 'Text'),
  makeCJSConfig('Modal', 'Modal'),
  makeCJSConfig('TextArea', 'TextArea'),
