...
var _jsxFileName$2="d:\\www\\my\\playground\\RNTestApp\\source\\components\\source\\TextArea.js";var areaStyles=reactNative.StyleSheet.create({style:{height:ELEMENT_MIN_SIZE*3},inputStyle:{textAlignVertical:'top'}});var TextArea=function TextArea(props){return React.createElement(TextInput$1,_extends_1({},props,{multiline:true,__source:{fileName:_jsxFileName$2,lineNumber:15}}));};var TextArea$1 = withStyles(TextArea,areaStyles,'TextArea');
